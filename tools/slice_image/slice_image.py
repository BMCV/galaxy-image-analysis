...
def slice_image(input_file, out_folder, label=None, label_out_folder=None, window_size=64, stride=1, bg_thresh=1, limit_slices=False, n_thresh=5000):
    ...
    new_path = out_folder+"/"+filename+"_%d.tiff"
...
if __name__ == "__main__":
    ...
    slice_image(args.input_file.name, args.out_folder,
                ...
                stride=args.stride, window_size=args.window_size, bg_thresh=args.bg_thresh, limit_slices=args.limit_slices, n_thresh=args.n_thresh)
